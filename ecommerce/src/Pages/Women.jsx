...
function Women({query,addToCart}) {
  const [fashion,setFashion]=useState(Dummydata);
  
    function filteWomenProduct(cate){
  ...
  return (
    <div>
      <div className="main flex flex-col mx-13 pt-14 md:pt-20">
        <h1 className='text-center text-3xl font-bold font-sans py-5'>Women's Collection</h1>
        ...
        <div className='flex flex-row justify-center items-center gap-10 text-2xl font-semibold mb-3'>
          ...
          <a href="./men" onClick={(e)=>{
            e.preventDefault()
            filteWomenProduct("Men")
          }}>Mens</a>
          <a href="./women" onClick={(e)=>{
            e.preventDefault()
            filteWomenProduct("Women")
          }}>Women</a>
          <a href="./baby" onClick={(e)=>{
            e.preventDefault()
            filteWomenProduct("Baby")
          }}>Baby's</a>
        </div>
